...
def DeepSea ():
	...
	print("You can learn about the environment, the animals or their adaptations, threats in the environment, and the regions the Deep Sea is found in. If you want to learn more, type more info.")
...
def Estuaries():
	...
	print("You can learn about the environment, the animals or their adaptations, threats in the environment, and the regions Estuaries are found in. If you want to learn more, type more info.")
	userinput = (raw_input("Enter what you want to know. If you want to go back to the main menu, type quit.").lower())
...
def PolarSeas():
	...
	print("You can learn about the environment, the animals or their adaptations, threats in the environment, and the regions Polar Seas are found in. If you want to learn more, type more info.")
	userinput = (raw_input("Enter what you want to know. If you want to go back to the main menu, type quit.").lower())
...
def ContinentalShelf():
	...
	print("You can learn about the environment, the animals or their adaptations, threats in the environment, and the regions the Continental Shelf is found in. If you want to learn more, type more info.")
	userinput = (raw_input("Enter what you want to know. If you want to go back to the main menu, type quit.").lower())
...
def CoralReef():
	...
	print("You can learn about the environment, the animals or their adaptations, threats in the environment, and the regions Coral Reefs are found in. If you want to learn more, type more info.")
	userinput = (raw_input("Enter what you want to know. If you want to go back to the main menu, type quit.").lower())
